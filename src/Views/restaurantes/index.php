...
<head>
    ...
    <title>Restaurantes — AcervoRCT</title>
    <style>
...
<body>
    ...
    <main>
        <div class="top">
            <h2>Restaurantes</h2>
            <a class="btn" href="/restaurantes/novo">+ Novo restaurante</a>
        </div>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($restaurantes)): ?>
                    <tr><td colspan="6" class="empty">Nenhum restaurante cadastrado.</td></tr>
                <?php else: ?>
                    <?php foreach ($restaurantes as $r): ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge <?= $r['ativo'] ? 'badge-green' : 'badge-red' ?>">
                                    <?= $r['ativo'] ? 'Ativo' : 'Inativo' ?>
                                </span>
                            </td>
                            <td>
                                <div class="actions">
                                    <a class="btn btn-secondary" href="/restaurantes/<?= $r['id'] ?>/edit">Editar</a>
                                    <form method="POST" action="/restaurantes/<?= $r['id'] ?>/delete"
