...
<head>
    ...
    <title><?= isset($livro) ? 'Editar' : 'Novo' ?> Livro — AcervoRCT</title>
    <style>
...
<body>
    ...
    <main>
        <h2><?= isset($livro) ? 'Editar Livro' : 'Novo Livro' ?></h2>
        ...
        <div class="card">
            ...
            <form method="POST" action="<?= isset($livro) ? '/livros/' . $livro['id'] : '/livros' ?>">
                <label for="nome">Nome *</label>
                <input
                    type="text"
                    id="nome"
                    name="nome"
                    value="<?= htmlspecialchars($livro['nome'] ?? $data['nome'] ?? '') ?>"
                    required
                    autofocus
                >
                ...
                <input
                    ...
                    id="autor"
                    name="autor"
                    value="<?= htmlspecialchars($livro['autor'] ?? $data['autor'] ?? '') ?>"
                >
                ...
                <input
                    ...
                    id="editora"
                    name="editora"
                    value="<?= htmlspecialchars($livro['editora'] ?? $data['editora'] ?? '') ?>"
                >

                <div class="actions">
                    <button class="btn btn-primary" type="submit">Salvar</button>
                    <a class="btn btn-secondary" href="/livros">Cancelar</a>
                </div>
            </form>
        </div>
    </main>
