...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge { display: inline-block; padding: 0.2rem 0.6rem; border-radius: 999px; font-size: 0.75rem; font-weight: 600; background: #dbeafe; color: #1d4ed8; }
...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($livros)): ?>
                    <tr><td colspan="6" class="empty">Nenhum livro cadastrado.</td></tr>
                <?php else: ?>
                    <?php foreach ($livros as $l): ?>
                        <tr>
                            ...
                            <td><span class="badge"><?= $l['total_receitas'] ?></span></td>
                            <td>
                                <div class="actions">
                                    <a class="btn btn-info" href="/livros/<?= $l['id'] ?>">Ver</a>
                                    <a class="btn btn-secondary" href="/livros/<?= $l['id'] ?>/edit">Editar</a>
                                    <form method="POST" action="/livros/<?= $l['id'] ?>/delete"
